...
| zip_attachment.eml | Group 34 | ZIP extraction: ZIP containing txt files with URLs and a nested ZIP with deeper URL |
...
`test_attachment.zip` is generated by `tests/create_test_zip.py`
and committed alongside `zip_attachment.eml` for reproducibility.
