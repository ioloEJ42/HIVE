...
- **Test suite** — 132 tests across 23 groups using five synthetic `.eml` samples covering parsing, nested emails, attachments, malformed headers, HTML-only bodies, defanging, filename sanitisation, batch processing, output collision, evidence integrity, and auth text formatting
